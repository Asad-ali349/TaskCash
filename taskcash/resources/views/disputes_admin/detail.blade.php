...
<div class="container-fluid">
                ...
                <div class="card-body">
                    ...
                    <table class="table table-bordered">
                        <tbody>
                            ...
                            @else
                            <form action="{{ url('reply/'.$dispute->id) }}" method="post" id="replyForm">
                                <tr>
                                    <th>Reply</th>
                                    <td>
                                        <textarea name="reply" id="reply" class="form-control" cols="30" rows="10"></textarea>
                                        <span class="text-danger error_reply"></span>
                                        <button type="submit" class="m-2 float-right btn btn-outline-primary">Done</button>
                                    </td>
                                </tr>
                            </form>
                            @endif --}}
    ...
    <div class="row mt-2">
        <div class="col-md-12">
            <div class="card">
                <div class="card-body order-list">
                    ...
                    @else
                        <p class="text-left text-dark"><b>Complainer</b>: {{ $chat->message }}</p>
                    @endif
        ...
        @if($dispute->status == 0)
        <div class="col-md-12">
            <form method="post" action="{{url('dispute/'.$dispute->id.'/reply')}}">
                {{csrf_field()}}
                <input type="hidden" name="sender" value="{{ Auth::guard('admin')->user()->id }}">
                <div class="form-group p-2">
                    ...
                    <div class="form-group">
                        <div class="col-lg-12 ml-auto text-right">
                            <a href="{{ url('/dispute/'.$dispute->id.'/resolve/') }}" class="btn btn-success">Resolve Query</a>
