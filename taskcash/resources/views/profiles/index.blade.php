            ...
            <div class="card m-b-20">
                <div class="card-body">
                    <div class="media">
                        ...
                        <img class="d-flex mr-3 rounded-circle thumb-lg" src="{{ asset('public/assets/images/'.Auth::guard('admin')->user()->image) }}" alt="Generic placeholder image">
                        @else
                        ...
                        <div class="media-body">
                            <h5 class="m-t-10 font-18 mb-1">{{ Auth::guard('admin')->user()->name }}</h5>
                            <p class="text-muted m-b-5">{{ Auth::guard('admin')->user()->email }}</p>
                        </div>
                    </div>
                </div>
                <div class="card-body">
                    <div class="row">
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="input-group mb-3">
                                        ...
                                        <input type="text" name="name" class="form-control" value="{{ Auth::guard('admin')->user()->name }}" placeholder="Name">
                                    </div>
                        ...
                        <div class="col-md-4 change_pass_div" id="change_pass_div" style="border:1px solid grey;box-shadow:2px 2px 4px black">
                            ...
                            <form action="{{ route('users.change.pass', Auth::guard('admin')->id()) }}" method="post" id="change_pass_form">
                            @csrf
