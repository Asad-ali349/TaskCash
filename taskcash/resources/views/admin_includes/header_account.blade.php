    ...
    <body>
        ...
        <div class="wrapper-page">
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <h3 class="text-center m-0">
                        <a href="index" class="logo logo-admin"><img src="{{ asset('public/assets/images/logo_dark.png') }}" height="30" alt="logo"></a>
                    </h3>
            ...
            <div class="m-t-40 text-center">
                ...
                <p>© 2019 TaskCash - Crafted with <i class="mdi mdi-heart text-danger"></i> by G7 Tech.</p>
            </div>
