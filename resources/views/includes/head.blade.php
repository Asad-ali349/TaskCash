<head>
    ...
    <link rel="icon" href="{{asset('public/assets/images/favicon2.png')}}" type="image/x-icon">
    <link rel="shortcut icon" href="{{asset('public/assets/images/favicon2.png')}}" type="image/x-icon">
    <title>House Deal Property Agent </title>
    <!-- Google font-->
